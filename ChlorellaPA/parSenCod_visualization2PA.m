...
eliminateMets = {'h_c','pi_c','atp_c','h2o_c','starch','dgtp_c','gtp_c','datp_c','adp_c'};
...
for f = 1:length(fieldNames)
    ...
    if ~isempty(group)
        ...
        if ~isempty(strmatch('allMets',groupname))
            ...
            save('3D_PA.mat','groupConectivity','groupCost','groupSens','groupCod','metTypes','group','Met','growth_sens_vector');
        end
