...
for f = 1:length(fieldNames)
    ...
    if ~isempty(group)
        ...
        groupCost = biosyntheticCost(model,mets(group),'ATPM','adp_c');
        ...
        saveas(gcf,['parSenCodCorrConec_Ch_',groupname],'svg')
         ...
         if ~isempty(strmatch('allMets',groupname))
            ...
            save('3D_Pt.mat','groupConectivity','groupCost','groupSens','groupCod','metTypes','group','Met','growth_sens_vector');
        end
