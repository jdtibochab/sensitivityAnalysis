...
%% Fixes
% M2MASN secretion
model = changeRxnBounds(model,'EX_glc__D_e',-0.6,'l');
...
model.ub(strmatch(exchange,model.rxns)) = reqExchange;
...
[yieldT,yieldTc,out,~,~,~,modelsPtHT] = yieldAnalysis(model,mets,Stoich,'EX_glc__D_e');
